...
56. [OrcaRouter Lite](https://github.com/Continuum-AI-Corp/OrcaRouter-Lite): a self-hosted, OpenAI-compatible LLM router with bring-your-own-key routing across 100+ models, automatic failover, streaming, and cost/latency-based model selection.
