...
53. [Bernstein](https://github.com/sipyourdrink-ltd/bernstein): Open-source governance layer for AI agents, built on a deterministic Python scheduler. Coordinates 40+ agent CLIs (Claude Code, Codex CLI, Gemini CLI, GitHub Copilot, Cursor, Aider, OpenHands, Goose, Qwen, Ollama, and more) running in parallel git worktrees. First-class MCP server, quality gates, cost tracking. Apache 2.0.
