...
33. [A3M Router (`🔥`)](https://github.com/Das-rebel/a3m-router): Open-source LLM router with parallel multi-LLM execution, 47+ providers, 62% cost savings. 19.5 KB, zero ML. npm fastest-growing router.
