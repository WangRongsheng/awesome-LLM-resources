...
20. [LLM-PQR](https://github.com/Amazed-Labs/llm-pqr): A provider-neutral CLI for comparing models by measured quality, reliability, latency, cost, capabilities, and hard local-only constraints.
