...
19. [UIZZE anti-ui-slop](https://github.com/uizze/uizze): 面向 Codex、Claude Code、Cursor、Copilot 等编码 Agent 的免费 UI 质量门禁 Skill 和 GitHub Action；可选的已认证 UIZZE MCP 用于检索 UI 参考，完整 UIZZE 还可检索 800,000+ 个真实 Web 和 iOS 界面。
