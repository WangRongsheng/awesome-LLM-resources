...
53. [Bernstein](https://github.com/sipyourdrink-ltd/bernstein): Multi-agent orchestrator for CLI coding agents. Coordinates 37 CLI coding agents (Claude Code, Codex CLI, Gemini CLI, GitHub Copilot, Cursor, Aider, OpenHands, Goose, Qwen, Ollama, and more) running in parallel git worktrees. Deterministic Python scheduler, first-class MCP server, quality gates, cost tracking. Apache 2.0.
